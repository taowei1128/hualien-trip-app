...
with tab_schedule:
    ...
    map_data = pd.DataFrame({
        'lat': [23.993, 23.995, 24.195, 23.978, 24.103, 23.483],
        'lon': [121.601, 121.593, 121.652, 121.603, 121.602, 121.516],
        'name': ['花蓮火車站', '煦家 HSU+', '崇德海灘', '老時光燒肉', '三棧溪', '石梯坪']
    })
    # 調整 zoom=10 可以讓畫面緊密鎖定在花蓮周邊
